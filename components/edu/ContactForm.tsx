...
const ContactHome: FC = () => {
    ...
    return (
        <div className={`absolute ${formView ? ' block right-[0%]' : 'right-[-80%] sm:right-[-450px] opacity-0.7 '} top-[20%] w-[90%] sm:w-[500px] form-animate`} onClick={() => showChat()}>
                ...
                <div className='relative'>
                    ...
                    <div className='relative bg-white md:block w-[100%] rounded-l-[50px] pt-[50px] font-lato'>
                            ...
                            <h1 className='text-[32px] font-semibold uppercase tracking-[.08em] my-[30px] ml-[10%]'>Get in touch.</h1>
                                    ...
                                    <div className="px-4 py-5 bg-white space-y-6 sm:p-6 ml-[10%] ">
                                        ...
                                        <div>
                                            <label htmlFor="about" className="block text-sm font-medium text-gray-700">
                                                <p className='text-[16px] font-semibold tracking-[.08em] my-[5px]'>Ihre Nachricht</p>
                                            </label>
                                            <div className="mt-1">
                                            <textarea
                                                id="about"
                                                ...
                                                placeholder="Bitte beschreiben Sie Ihr Projekt mit einigen Eckdaten.
