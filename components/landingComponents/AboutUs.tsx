                    ...
                    <div className='z-50 w-full'>
                        ...
                        <div ref={animFadeIn} className=' md:flex relative top-[-80px] md:top-0'>
                            ...
                            <div className='relative h-[400px] w-full md:static md:w-2/5'>
                                <svg className='z-0 fixed w-[180%] sm:top-[-70%] sm:w-[120%] translate-x-[-50%] top-[-220px] left-[45%] md:w-full md:left-[25%] md:translate-x-0 md:top-[50%] md:translate-y-[-50%]' viewBox="0 0 1295 1294" fill="none" xmlns="http://www.w3.org/2000/svg">
