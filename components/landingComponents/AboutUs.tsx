                    ...
                    <div>
                        ...
                        <div ref={el => { if (el && animFadeIn.current.indexOf(el) == -1) animFadeIn.current.push(el) }} className=' md:flex relative'>
                            ...
                            <div className='relative w-full md:w-2/5 mdLh-[300px] w:h-auto'>
                                ...
                                <svg className='md:absolute translate-x-[-13%] z-30 top-[-85%] left-[-50%] md:top-[85%] md:translate-y-[-50%]  sm:top-[-70%] sm:left-[-2%] w-[130%] xl:left-[-63%] md:left-[-100%] md:w-[100%] xl:w-[249%] ' viewBox="0 0 1295 1294" fill="none" xmlns="http://www.w3.org/2000/svg">
