                    ...
                    <div>
                        ...
                        <div ref={el => { if (el && animFadeIn.current.indexOf(el) == -1) animFadeIn.current.push(el) }} className=' md:flex relative top-[-80px] md:top-0'>
                            ...
                            <div className='relative h-[400px] w-full md:w-2/5 md:h-[300px] w:h-auto'>
                                ...
                                <svg className='w-[180%] sm:w-[120%] md:w-full xl:w-[249%] absolute translate-x-[-50%] z-30 top-[-220px] left-[45%] md:translate-x-[-13%] md:top-[85%] md:translate-y-[-50%]  sm:top-[-70%]' viewBox="0 0 1295 1294" fill="none" xmlns="http://www.w3.org/2000/svg">
