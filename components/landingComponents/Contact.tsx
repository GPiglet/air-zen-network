            ...
            <div id='cantact' className='container m-auto relative py-[120px] md:py-[280px] flex justify-center'>
                <div className=" flex justify-center">
                    <div className='md:w-[50%] xl:w-1/3 text-center relative px-10 md:px-auto'>
                        ...
                        <p className='font-lato text-lg text-white mt-11 text-left tracking-widest'>Highend-Netzwerk-Technologien für einen entspannteren Alltag und Arbeitswelt. Und das außer- gewöhnlich einfach, sicher und zuverlässig.</p>
                        <CustomInput
                            label='Name'
                        ...
                        Ich habe die Datenschutz- erklärung gelesen und stimme der Speicherung und Verarbeitung meiner Daten durch die AirZen Networks Lda zu.
                        </p>
                        <p className='font-lato font-light text-left text-base text-white tracking-[2px] my-4'>Ich willige ein, dass meine Daten zur Beantwortung meiner Anfrage elekronisch erhoben und gespeichert werden. Ich kann meine Einwilligung jederzeit widerrufen: privacy@airzen.io </p>
