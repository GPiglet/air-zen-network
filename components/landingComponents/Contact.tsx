    ...
    return (
        <>
            <div id='cantact' ref={(el) => { containerRef.current = el; if (ref) ref.current = { container: el, startAnim } }} className='container m-auto relative py-[120px] md:py-[280px] flex justify-center md:hidden'>
                    ...
                    <div className='text-white md:w-[50%] xl:w-1/3 text-center relative z-40 px-10 md:px-auto'>
                        ...
                        <div ref={el => { animSlideUp.current.push(el); animFadeIn.current.push(el) }} className='flex relative z-40'>
                            <div className='mt-5 mr-3'>
                                <CustomCheckbox checked={dataProtection} state='protectoin' onChange={() => changeCheck('dataProtection')} />
                            </div>
                        ...
                        <div ref={el => { animSlideUp.current.push(el); animFadeIn.current.push(el) }} className='flex relative z-40'>
                            <div className='mt-5 mr-3'>
                                <CustomCheckbox checked={dataCollection} state='collection' onChange={() => changeCheck('dataCollection')} />
                            </div>
                            <p className='font-lato font-light text-left text-base text-white tracking-[2px] my-4'>
                                {t('landing.contact.description').split('\n')[1]}
                            </p>
                ...
                <svg ref={el => { animSlideRight.current.push(el) }} className='hidden md:block absolute opacity-80 w-[40%] right-0 top-[80px]' viewBox="0 0 608 553" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g opacity="0.7">
