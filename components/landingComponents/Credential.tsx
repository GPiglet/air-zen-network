...
const Credential = React.forwardRef((props: any, ref: any) => {
    ...
    return (
        <section id='credentials' ref={(el) => { containerRef.current = el; if (ref) ref.current = { container: el, startAnim } }} className='container md:overflow-hidden flex md:block md:pt-[160px] h-[80vh] md:h-screen items-center md:items-start md:fixed md:hidden md:w-full md:left-[50%] md:translate-x-[-50%]'>
