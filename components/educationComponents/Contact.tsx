...
const Contact: FC = () => {
    ...
    return (
        <section className="pb-[500px] relative mb-[800px] md:mb-0  overflow-x-clip">

            <svg className="absolute
            top-[-600px] sm:top-[-650px] md:top-[-35%]
            xs:w-[900px] sm:w-[140%] md:w-[70%] max-w-[962px]
            left-[-235px] sm:left-[-10%] md:left-[6%] 2xl:left-[-1%]" viewBox="0 0 909 901" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="mx-auto relative md:pl-[20%] md:pt-[10%] lg:pt-[20%]">
                <div className="">
                    <div className="w-full md:w-2/5 px-10">
