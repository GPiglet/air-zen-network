    ...
    return (
        <div className="relative container mx-auto mb-[70%] md:mb-[10%] lg:mb-[15%] xl:mb-[25%]">
            ...
            viewBox="0 0 878 926" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <image href="/images/education1.png" width="750" height="950" clipPath="url(#myCircle1)" x="9%" y="-4%" fillOpacity='1' />
                ...
                <image href="/images/education2.png" width="480" height="780" clipPath="url(#myCircle2)" x="35%" y="33%" fillOpacity='1' />
                <defs>
