...
const Reliable: FC = () => {
    ...
    return (
        <div className="container mx-auto relative mb-[80%] sm:mb-[60%] md:mb-[0%] xl:mb-[10%]">
            
            <svg className="absolute
            left-[5%] sm:left-[15%] md:left-[-25%] lg:left-[-30%] xl:left-[-25%]
            top-[100%] md:top-[5%] lg:top-[-9%] xl:top-[-50%]
            w-[80%] sm:w-[60%] md:w-[65%] lg:w-[70%] xl:w-[60%]" viewBox="0 0 723 797" fill="none" xmlns="http://www.w3.org/2000/svg">
