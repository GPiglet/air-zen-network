...
const Solution360: FC<{ props?: any, ref: any }> = React.forwardRef((props: any, ref: any) => {
    ...
    return (
        <section id='solution' ref={(el) => { containerRef.current = el; if (ref) ref.current = { container: el, startAnim } }} className='h-screen container m-auto relative md:h-screen md:fixed md:hidden md:left-[50%] md:translate-x-[-50%]'>
