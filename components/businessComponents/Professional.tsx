...
const Professional: FC<{ props?: any, ref: any }> = React.forwardRef((props: any, ref: any) => {
    ...
    return (
        <section id="professional" ref={(el) => { containerRef.current = el; if (ref) ref.current = { container: el, startAnim } }} className="container relative pb-16 items-center mx-auto md:flex md:h-screen md:fixed md:hidden md:left-[50%] md:translate-x-[-50%]">
            <div className="z-10 relative text-center text-white px-10 md:pt-[0] md:mt-0 md:mx-auto">
                <div className="w-full">
                    ...
                    <div className="md:flex justify-between text-lg text-left mt-10 tracking-[0.08em] sm:flex">
                        <div className="w-[160px] sm:hidden"></div>
                        {
            ...
            <div className="z-0 relative md:static h-[26rem] sm:h-[34rem] md:h-auto">
                <svg className="absolute left-1/2 top-[-50%] translate-x-[-50%] w-[200%] sm:w-[150%] sm:top-[-55%] md:translate-x-0 md:top-[34%] md:w-[100%] md:left-[-41%] md:translate-y-[-50%] xl:left-[-40%]" viewBox="0 50 679 550" fill="none" stopOpacity='0.2' xmlns="http://www.w3.org/2000/svg">
                    <g opacity="0.8">
                        ...
                        <path className="opacity-0 md:opacity-60" d="M124.965 464.45C56.367 345.635 96.8264 193.852 215.33 125.434C333.834 57.0156 485.511 97.8679 554.11 216.684C622.708 335.5 582.249 487.282 463.745 555.7C345.241 624.119 193.564 583.266 124.965 464.45Z" stroke="url(#paint1_radial_1376_5657)" />
                    </g>
                    <image
            ...
            <svg className="z-0 hidden md:block absolute right-[-42%] top-[66%] md:bottom-[-10%] lg:top-30%] md:w-[50%]   sm:top-[43%] sm:w-[200%] sm:right-[-54%] w-[174%] md:right-[-31%] xl:right-[-23%] " viewBox="0 0 525 523" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g opacity="0.6">
