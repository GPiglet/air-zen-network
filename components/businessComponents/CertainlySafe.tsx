...
const CertainlySafe: FC = () => {
    ...
    return (
        <section className="pb-16 relative container mx-auto  py-[150px]">
            <svg className="absolute left-[-27%] bottom-[-50%] w-[140%] sm:top-[70%]  md:top-1/2 md:translate-y-[-50%] sm:w-[120%] md:w-[100%] xl:w-[75%]   sm:left-[-10%]  md:left-[-45%] xl:left-[-20%]" viewBox="0 0 692 692" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g opacity="0.8">
