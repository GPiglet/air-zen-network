...
const CertainlySafe: FC = () => {
    ...
    return (
        <section className="pb-16 relative container mx-auto  py-[150px]">
            <svg className="absolute left-[50%] translate-x-[-50%] md:translate-x-0 bottom-[-50%] w-[140%] sm:top-[70%]  md:top-1/2 md:translate-y-[-50%] sm:w-[120%] md:w-[100%] xl:w-[75%]  md:left-[-45%] xl:left-[-20%]" viewBox="0 0 692 692" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g opacity="0.8">
            ...
            <div className="relative items-center pt-[250px]  sm:pt-[20%] md:pt-0 px-10 md:px-0 md:absolute md:top-1/2 md:translate-y-[-50%]">
