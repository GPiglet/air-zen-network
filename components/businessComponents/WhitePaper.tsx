        ...
        <div className='container text-white md:flex items-center m-auto py-[100px]'>
            <div className='w-full text-center '>
                <div>
                    ...
                    <p className="font-lato-light font-light italic text-lg tracking-widest">Hier finden Sie tiefer gehende Informationen zu unserem Service.</p>
                </div>
                <div className='md:flex justify-between text-left mt-[120px]'>
                    <div className='px-12 mb-10 relative'>
                        <p className="font-lato-light font-light italic text-lg tracking-widest">Whitepaper</p>
                        <h1 className="text-title-sm ">
                            Home-Office für alle
                        </h1>
                        <p className='font-lato text-lg'>Ob groß oder klein: AirZen bietet vielfältige, individuelle Netzwerklösungen für Ihr Home-Office. Für weitere Infos zu unseren Services und Hardfacts werfen Sie einen Blick in unser Whitepaper.</p>
