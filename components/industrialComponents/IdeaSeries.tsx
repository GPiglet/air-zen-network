    ...
    return (
        <div ref={(el) => { containerRef.current = el; if (ref) ref.current = { container: el, startAnim } }} className="container mx-auto relative md:flex items-center md:h-screen md:fixed md:hidden md:left-[50%] md:translate-x-[-50%]">
            ...
            <div className="relative h-[44rem] sm:h-[52rem] md:static md:h-auto" >
                <svg className="absolute left-1/2 translate-x-[-50%] top-[-10%] w-[170%] sm:left-[-64%] md:left-[-43%] md:translate-x-0 xl:left-[-19%] sm:top-[46%] md:top-1/2 md:translate-y-[-50%] w-[100%] md:w-[100%] xl:w-[55%]"
