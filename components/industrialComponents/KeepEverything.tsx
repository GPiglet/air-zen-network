...
const KeepEverything: FC = () => {
    ...
    return (
        <section className="pb-16 relative  overflow-x-clip">
            ...
            <svg className="absolute right-[12%] bottom-[-12%] md:top-[15%] lg:top-[20%] md:w-[75%] 2xl:w-[1024px]  sm:top-[59%] sm:w-[80%]  w-[84%] md:right-[-14%] lg:right-[-11%] xl:left-[37%] " viewBox="0 0 853 538" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <image href="/images/macbook.png" x="10.5%" y="16%" className="w-[70%]"></image>
            ...
            <svg className="hidden md:block xl:hidden md:w-[20%] absolute top-[30%] " viewBox="0 0 356 374" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="md:flex items-center mt-5 md:mt-0  md:h-[60%]">
                    <div className="md:w-[350px] xl:w-[40%]">
                        ...
                        <p className="font-lato font-light tracking-widest text-lg mt-3">
                            Durch Stabilität, Sicherheit und einfache Nutzung
                            bieten die AirZen weitreichende Individualisierung für industrielle
                            Netzwerke in vielen Bereichen ganz neue
                            Möglichkeiten Prozesse abzuwickeln, neue Leistungen
                            anzubieten und ganz neue Maßstäbe für Industrie 4.0
                            zu setzen.
                        </p>
