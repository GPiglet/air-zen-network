...
const HomeForm: FC = () => {
    ...
    const {step} = useContext(StoreContext)
    ...
    return (
        <div>
            ...
            {
                <div className={`w-full absolute  ${formView ? ' block right-[-20px]' : 'right-[-100%] md:right-[-600px]'} top-[25%] bg-white  md:w-[600px] rounded-xl py-[58px] pl-[60px] pr-0 font-lato form-animate tracking-[0.8em] overflow-clip`}>
                        <svg width="214" height="219" className='absolute top-[-60px] left-[-50px]' viewBox="0 0 214 219" fill="none" xmlns="http://www.w3.org/2000/svg">
