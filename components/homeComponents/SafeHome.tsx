...
const SafeHome: FC = () => {
    ...
    return (
        <section className="pb-16 relative  overflow-x-clip py-[150px]">
            <svg className="absolute left-[-37%] top-[66%]  md:top-1/2 md:translate-y-[-50%] md:w-[65%] 2xl:w-[60%]  sm:top-[37%] sm:w-[120%] sm:left-[-10%] w-[174%] md:left-[-14%]" viewBox="0 0 804 796" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="container mx-auto relative items-center px-10 md:px-0 md:h-[70%]">
                <div className="flex flex-wrap mt-12 md:mt-24">
                    <div className="w-full md:w-1/2 m-auto">
                        <p className="font-lato-light italic font-light text-[22px] text-white">Sicher</p>
                        <h1 className="font-lato font-medium text-[32px] text-white uppercase tracking-[0.08em]">Home safe home</h1>
                        <p className="font-lato font-light tracking-widest text-white text-lg mt-3">Mit AirZen genießen Sie optimalen Schutz und Kontrolle durch automatische Updates, Trennung von verschiedenen Netzen, Internet Watch Dog, Pause-Button und Filtern für Kinder. Die individuelle Passwortvergabe ermöglicht nicht nur personalisierte Rechtevergabe, sondern erhöht auch die Sicherheit Ihres Wifi enorm.</p>
                    </div>
                </div>
            </div>
        </section>
