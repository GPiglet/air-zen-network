...
const SafeHome: FC = () => {
    ...
    return (
        <div id="secure" className="container mx-auto relative md:h-screen">
            <svg className="hidden md:block absolute left-[-27%] bottom-[-28%] w-[140%] sm:top-[37%]  md:top-1/2 md:translate-y-[-50%] sm:w-[120%] md:w-[100%] xl:w-[90%]   sm:left-[-10%]  md:left-[-45%] xl:left-[-40%]" viewBox="0 0 804 796" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className=" relative md:hidden items-center px-10 md:px-0 h-full mt-[100px] md:mt-0">
                <div className="flex flex-wrap">
                    {/* <div className="w-[20%]"></div> */}
                    <div className="w-full md:w-1/2 m-auto">
