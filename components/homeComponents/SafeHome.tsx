...
const SafeHome: FC = () => {
    ...
    return (
        <section className="container mx-auto relative">
            <svg className="absolute left-[-27%] bottom-[-7%] w-[140%] sm:top-[37%]  md:top-1/2 md:translate-y-[-50%] sm:w-[120%] md:w-[100%] xl:w-[65%]   sm:left-[-10%]  md:left-[-45%] xl:left-[-20%]" viewBox="0 0 804 796" fill="none" xmlns="http://www.w3.org/2000/svg">
