...
const Easy: FC = () => {
    ...
    return (
        <section className="pb-16 relative  overflow-x-clip py-[150px]">
            <svg className="hidden md:block absolute left-[-37%] top-[95%]  md:top-1/2 md:translate-y-[-50%] md:w-[65%] 2xl:w-[60%]  sm:top-[80%] sm:w-[120%] sm:left-[-10%] w-[174%] md:left-[-14%]" viewBox="0 0 804 796" fill="none" xmlns="http://www.w3.org/2000/svg">
