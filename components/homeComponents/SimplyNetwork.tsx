...
const SimplyNetwork: FC<{ props?: any, ref: any }> = React.forwardRef((props: any, ref: any) => {
    ...
    return (
        <section ref={(el) => { containerRef.current = el; if (ref) ref.current = { container: el, startAnim } }} className="container mx-auto relative md:fixed md:h-screen md:hidden md:left-[50%] md:translate-x-[-50%]">
            ...
            <div className="relative md:sticky md:absolute md:top-1/2 md:translate-y-[-50%] items-center px-10 md:px-0 pt-[300px] sm:pt-[400px] md:pt-[150px] md:pt-0">
                <Breadcrumb />
                ...
                <svg className="z-0 top-[-55px] absolute translate-x-[-16%] sm:translate-x-[-9%] md:translate-x-0 bottom-[-27%] md:top-1/2 md:translate-y-[-50%] md:w-[100%] md:right-[-53%]  xl:w-[120%]   sm:top-[-20%] sm:w-[120%] sm:right-[-42%] w-[160%]  xl:right-[-44%] " viewBox="0 0 817 750" fill="none" xmlns="http://www.w3.org/2000/svg">
