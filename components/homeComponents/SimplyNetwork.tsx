...
const SimplyNetwork: FC = () => {
    ...
    return (
        <section className="container mx-auto pb-16 relative">
            <svg className="absolute right-[-36%] top-[55%] md:top-[-10%] lg:top-[-20%] md:w-[140%] md:right-[-53%]  xl:w-[120%]   sm:top-[37%] sm:w-[120%] sm:right-[-12%] w-[174%]  xl:right-[-44%] " viewBox="0 0 817 828" fill="none" xmlns="http://www.w3.org/2000/svg">
