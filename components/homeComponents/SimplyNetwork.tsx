...
const SimplyNetwork: FC<{ props?: any, ref: any }> = React.forwardRef((props: any, ref: any) => {
    ...
    return (
        <section ref={(el) => { containerRef.current = el; if (ref) ref.current = { container: el, startAnim } }} className="container mx-auto relative md:fixed md:h-screen md:hidden md:left-[50%] md:translate-x-[-50%]">
            ...
            <svg className="md:absolute translate-x-[-22%] sm:translate-x-[-9%] md:translate-x-0 right-[-36%] bottom-[-27%] md:top-1/2 md:translate-y-[-50%] md:w-[100%] md:right-[-53%]  xl:w-[120%]   sm:top-[37%] sm:w-[120%] sm:right-[-12%] w-[174%]  xl:right-[-44%] " viewBox="0 0 817 750" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <image href="/images/homeContent1.png" width="600" height="350" clipPath="url(#myCircle)" x="12.5%" y="31%" fillOpacity='0.5' />
            </svg>
        </section>
