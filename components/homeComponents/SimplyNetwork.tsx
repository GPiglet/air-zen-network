...
const SimplyNetwork: FC = () => {
    ...
    return (
        <section className="pb-16 relative  overflow-x-clip">
            <svg className="absolute right-[-52%] top-[55%] md:top-[-10%] lg:top-[-200px] md:w-[100%] 2xl:w-[1350px]  sm:top-[37%] sm:w-[120%] sm:right-[-20%] w-[174%] md:right-[-25%] lg:right-[-22%] " viewBox="0 0 817 828" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="container mx-auto relative items-center px-10 md:px-0 md:h-[70%]">
                ...
                <div className="flex flex-wrap mt-12">
                    <div className="w-full md:w-7/12">
                        <h1 className="text-title-sm">Einfach gutes netz.</h1>
