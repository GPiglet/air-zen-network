...
const Reliable: FC = () => {
    ...
    return (
        <section className="pb-16 relative flex items-center  overflow-x-clip">

            <svg className="absolute right-[-52%] top-[76%] sm:top-[55%] md:top-[-57%] lg:top-[-500px] md:w-[100%] 2xl:w-[1350px]   sm:w-[140%] sm:right-[-20%] w-[204%] md:right-[-25%] lg:right-[-36%] xl:right-[-480px] " viewBox="0 0 907 907" fill="none" xmlns="http://www.w3.org/2000/svg">
